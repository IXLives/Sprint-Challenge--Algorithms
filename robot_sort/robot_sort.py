...
# My plan for this robot is to use bubble sort to swap the largest element to the end of the array
# Turn on the light
...
#
    ...
    def sort(self):
        ...
        if self.light_is_on == True:
            if self.can_move_left == False and (self.compare_item() == None or -1):
                self.swap_item()
                self.move_right()
